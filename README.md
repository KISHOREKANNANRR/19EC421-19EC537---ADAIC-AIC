...
PROCEDURE:
Inverting amplifier:
Select R1 as a constant value and choose a value of Rf.
Connect the circuit as per as the circuit diagram.
Apply the constant amplitude input voltage to the circuit.
Measure the output voltage amplitude for different value of V1 from DSO.
Calculate the practical Voltage for different value of V1 & compare it with theoretical output.
Practical gain & theoretical voltage should be approximately equal.
Plot the graph of the input wave versus output wave for any one practical case.
...
Select R1  as a constant value and choose a value for Rf .
Connect the circuit as per the diagram.
Apply constant amplitude input voltage.
Measure the output voltage amplitude for different V1 using DSO.
Compare practical and theoretical values of Vo .
Verify that practical gain ≈ theoretical gain.
Plot the input vs. output waveform for one practical case.
TABULATION
...
Select  R1, R2, R3, Rf  such that R1 = R2  and  R3 = Rf .
Connect the circuit as per the circuit diagram.
Apply constant inputs Vin1 and  Vin2 .
Measure output voltage using DSO.
Compare theoretical and practical  Vo .
Verify practical ≈ theoretical output.
Plot the input vs. output waveform.
---
...
PROCEDURE:
Select the entire resistor with the same value. Let R be the gain varying resistor with different values of resistance for simplicity let R be a constant value.
Connect the circuit as shown in the circuit diagram.

Vcc and - Vcc supply is given to the power supply terminal of the Op-Amp IC.
Give the input V1 and V2 to the non-inverting terminals of first & second op-amp respectively.
By varying the value of RG, measure the output voltage for common mode and differential mode operation. Since RG is selected as constant value, provide different input value of V1 and V2.
Check the theoretical value with the experimental value.
The output voltage is obtained in the Multimeter and the input and output voltage waveforms are plotted in a graph sheet
---
